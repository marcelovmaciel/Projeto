...
%
%-------------------------------------------------------------------------
\titulo{Emergência de Distribuições de Preferências Ideológicas: Uma abordagem
  computacional}
...
%-------------------------------------------------------------------------
  ...
  Ciências pelo Programa de Pós-graduação em Modelagem de Sistemas Complexos, na
  área de concentração ?????, aprovada em \_\_\_\_\_\_\_ de
...
\begin{agradecimentos}
  Familia, amigos , colegas , professores, orientador.
\end{agradecimentos}
% ---
