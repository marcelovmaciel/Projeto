...
formal, matemática ou computação \cite{morton1999methods}. Nosso foco na
...
conformidade com os axiomas da probabilidade, suas preferências podem ser e
atualizam suas crenças de acordo com o Teorema de Bayes.
...
O pressuposto modal é que métrica é Euclidiana: os agentes medem a distância
entre dois pontos no espaço de alternativas usando o Teorema de Pitágoras
\cite{munger2015choosing}. Ademais, assume-se, por conveniência analítica,
funções com um único pico ( o ponto ideal do agente) e simétricas. Funções de
utilidade usualmente utilizadas na ciência política são a linear, a quadrática e
a gaussiana, ilustradas na Figura 1:
...
seminais de Black e Downs. Em geral, em votos em comitê o número de agentes é
...
Como as preferências no contexto eleitoral necessariamente são
...
distribuições de auto-posicionamento ideológico, ilustradas na Figura 3, no
\textit{European Social Survey}: há um pico central dominante; há uma tendência
para a existência de \textit{clusters} não centrais, mas não extremos; e há uma
