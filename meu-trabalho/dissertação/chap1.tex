...
pode ser considerado como ``essencialmente contestado'': é um conceito
...
Nosso foco na literatura em teoria política formal é justificado pelo fato desta
...
\citeonline{binmore2008rational} a aplicação do modelo da decisão racional em
...
A instabilidade nas respostas a \textit{surveys} e a suscetibilidade dos
...
levam \citeonline{bartels2003democracy} a contestar o uso da noção de
...
\cite{poole2005spatial,laver2014measuring}. \citeonline{poole1985ideology}
...
\citeonline{benoit2006party} encontra que no máximo três dimensões são
...
\caption{Evidência de estabilidade ideológica}
  ...
  \source{Marcelo Veloso Maciel, 2018. Dados do \textit{European Social Survey}.}
\end{figure}
...
Como argumenta \citeonline{page2008uncertainty} essa estratégia de modelagem
...
$n>1$, argumentam \citeonline{laver2011party}, agir de maneira ótima é, contudo,
