...
veementemente pela segunda\todo{falar mais do que diz a psicologia politica}
\cite[p.5]{bendor2011behavioral}. A falta de conhecimento sobre temas/questões e
a instabilidade de resposta\todo[color=yellow!10]{explicar instabilidade} a
...
Como as preferências no contexto eleitoral necessariamente são construídas a
...
e cristalização. Convergimos assim para um argumento análogo ao de
\citeonline{converse2006nature}: o direcionamento político, ou ideologia, do
agente é resultado, ou construído, a partir de um ``campo de atitudes'', que no
Capítulo 3 chamaremos de perfil ideológico, o qual por sua vez é explicável por
meio da socialização do agente, a interação de suas atitudes com as atitudes dos
pares. No Capítulo 2 discutimos a literatura em dinâmicas de opinião que nós dá
o arcabouço para modelar esse processo.

\todo[inline,color=yellow!10]{Rever o próximo paragrafo}
...
\todo[inline,color=yellow!10]{Explicar as escalas da figura}
...
\textit{benchmark}.\todo[color=yellow!10]{Explicar isso de benchmark}
