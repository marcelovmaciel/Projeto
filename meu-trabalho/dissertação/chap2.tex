...
\item AMBs muitas vezes não tem supervisores/controladores centrais;
  ...
  \cite{north2007managing}\footnote{Essas propriedades são ditas emergentes na
    medida em que caracterizam o sistema e não seus componentes. Em sua forma
    mais simples elas condicionam indiretamente o comportamento dos agentes. Se
    os agentes tiverem consciência dessa propriedade sistêmica temos, contudo,
    ...
    \textit{feedbacks} indiretos, ou emergência de primeira ordem.}. Não por
  acaso, ABMs são amplamente usados em OD
 ...
 Se calcularmos o $E_i(\theta)$ da expressão anterior temos a nova opinião:
  ...
  incerteza dos agentes é atualizada:
    ...
    (\frac{o_i(t)-o_j(t)}{2})^2
      ...
      percentual, demonstrando na Figura \ref{fig5}, dos respondentes em um
      ...
      incorporar não só a dinâmica da opinião dos agentes, mas também como se
      tornam mais ou menos confiantes.
          ...
          Fonte: \citeonline{kuklinski2000misinformation}
          \label{fig5}
        \end{figure}
