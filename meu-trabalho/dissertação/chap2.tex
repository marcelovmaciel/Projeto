...
\item AMBs muitas vezes não tem supervisores/controladores centrais;
  ...
  \cite{castellano2012social,flache2017}. \todo[inline,color =
  yellow!10]{Explicar melhor isso, pegar a referencia dada por carlos; falar em
    abordagem bottom-up.}
...
Como  argumentado por \citeonline{zaller1992nature}, a estratégia
 ...
 Se calcularmos o $E_i(\theta)$ da expressão anterior temos a nova opinião:
  ...
  incerteza dos agentes é atualizada:
    ...
    (\frac{o_i(t)-o_j(t)}{2})^2
      ...
      com o passar do tempo os agentes fiquem mais certos de suas opiniões. Isso
      é relevante do ponto de vista da modelagem generativa de opinião pública.
      \citeonline{kuklinski2000misinformation} encontra que um grande
