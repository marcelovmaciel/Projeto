...
multiplicação do likelihood e o prior normal de $i$:
 ...
 Se calcularmos o $E_i(\theta)$ da expressão anterior temos a nova opinião:
  ...
  \citeonline{martins2009bayesian} o agente age segundo a heurística pela
  ...
  incerteza dos agentes é atualizada:
    ...
    (\frac{x_i(t)-x_j(t)}{2})^2
      ...
      Como demonstra \citeonline{martins2009bayesian} essa equação faz com que o
      ...
      incorporar não só a dinâmica da opinião dos agentes, mas como também como
