...
Esse é um atributo global para cada repetição da simulação\footnote{Onde
  ...
  \cite{laver2011party}.}. \todo[inline,color=yellow!10]{Aqui fica a dúvida , à
  espera da resposta de Andre..., se vou ter dois casos mesmo, ou um único em
  que os agentes só atualizam sob 2.3 e 2.4, mas não 2.5, e NA CONDIÇÃO INICIAL
  eu estabeleço uma proporção de agentes confiantes. Estaria trocando um Caso
  por um parâmetro a mais, o que acho razoável (do ponto de vista operacional).}
