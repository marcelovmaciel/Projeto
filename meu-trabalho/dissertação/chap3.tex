...
teóricos.\todo[inline,color = yellow]{Vou discutir mais isso do ruido}
...
Os parâmetros-chave para configuração e inicialização do modelo no tempo \(t =
0\), cujos valores seguem \citeonline{martins2008continuous},
\citeonline{deffuant2000mixing} e \citeonline{lorenz2017modeling}, são:
\begin{itemize}
