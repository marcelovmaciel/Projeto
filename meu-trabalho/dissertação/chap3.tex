...
Como mostra a figura \ref{fig:box4} quanto maior o valor de \(\sigma\) menos dispersão
configuração final. Contudo um resultado que aparentar ser contrário ao da análise anterior é que
quanto maior o número de questões \textit{maior} a dispersão final. Isso só é
verdade, contudo, pelo fato dos parâmetros \(\rho\) e \(p\_intran\) serem nulos.

\todo[inline,color = yellow!10]{Daqui faço os plots com n> 1 os sigmas ja usados
e \(\rho\)e p\_intran diferentes de zero.}
