...
\begin{figure}[H]
    ...
    único valor, na figura \ref{fig:tseries2} a população oscila no espaço onde
    há mais intransigentes. O parâmetro parece assim um impacto sobre a
    dinâmica. Como nem o desvio padrão nem o número de pontos ideais finais,
