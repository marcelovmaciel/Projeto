...
A cada iteração da simulação um dos agentes vai ser escolhido e vai
...
\begin{figure}[H]
  ...
  \caption{Evolução dos pontos ideais quando há ruído e agentes intransigentes.
    ...
    \citeonline{deffuant2000mixing}. Nosso modelo  recupera também,
    de duas formas distintas, a convergência da maioria da população a um dos
    extremos encontrada por \citeonline{deffuant2002can} por meio tanto de
    intransigentes nos extremos, quanto de agentes não totalmente intransigentes
    distribuídos ao longo do espectro político.

    Um comportamento novo encontrado usando o modelo é a importância
    ...
    por \citeonline{flache2017} modelos de dinâmicas de opinião levam
