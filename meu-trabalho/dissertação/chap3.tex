...
arredondar os pontos ideais finais, para digamos 5 casas decimais, para
chegarmos a conclusão que existem ``clusters''. Se não arrendondarmos o
...
\textcolor{red}{Aqui comparar a dispersao dos pontos ideais na condição inicial
  e ao fim ; pra isso tenho que gerar mais um vetor}
%
...
os parâmetros. Além disso os coeficientes de erro são pequenos, como mostra a
Tabela \textcolor{red}{gerar a tabela}, tendo em vista que a análise foi feita a partir de 70.000
...
Testamos então novamente o impacto dos parâmetros, mas agora mantendo \(N =
500\) e tendo por medida o número de pontos ideais (Ynips), arredondando os
pontos ideais em 5-6 casas decimais.

\begin{figure}[H]
  \centering
  \includegraphics{ims/timeseries3.png}
  \caption{Evolução dos pontos ideais dos agentes ao longo de uma realização.
        Parametrização: \(  N = 500, p = 0.9, \rho = 0.0, n\_issues = 1 , p\_intra
        n= 0.15 \)}
  \label{fig:tseries2}
\end{figure}
